...
for cell in nb['cells']:
    if cell.get('cell_type') == 'code' and 'MODEL_SERVER_CODE =' in ''.join(cell.get('source', [])):
        cell['source'] = [
            ...
            'import requests\n',
            '\n',
            'MODEL_SERVER_CODE = \'\'\'' + model_server_code + '\'\'\'\n',
            '\n',
...
print('Updated colab/frameseek_colab_runner.ipynb successfully')
